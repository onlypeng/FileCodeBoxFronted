export default {
  ...
  manage: {
    settings: {
      ...
      directRelayChunkSize: 'Relay chunk size',
      directRelayChunkSizeHint: 'Chunk size (KB, 16~256) for relaying files in rooms. Each encrypted chunk slightly exceeds the raw size; a smaller value avoids gateway/proxy single-frame limits (commonly 256KB). Default is 64.',
      directMaxRelaySize: 'Relay file size limit',
      directMaxRelaySizeHint: 'Max single file size (MB, 0=unlimited) relayed through the server in rooms. Independent of the general upload size limit and only applies to server-relayed room files; P2P direct transfers are unaffected.',
      kb: 'KB',
    ...
    systemSettings: {
      ...
      s3Storage: 'S3 Object Storage',
      webdavStorage: 'WebDAV Storage',
      chunkUploadNote: 'Chunked upload (more reliable for large files)',
      chunkUploadHint: 'When enabled, large files on the send/delivery pages are split by "chunk size" below and uploaded with resume support; otherwise uploaded directly.',
      uploadChunkSize: 'Upload chunk size',
      uploadChunkSizeHint: 'Chunk size (MB, 1~100, default 5) used for chunked uploads on send/delivery pages. The backend validates against it, and S3 storage merges by this size.',
      enabled: 'Enabled',
      disabled: 'Disabled',
      webdavUrl: 'Enter WebDAV server URL',
      webdavUsername: 'Enter WebDAV username',
  ...
  direct: {
    create: {
      ...
      saveMessagesLabel: 'Save messages on server',
      saveMessagesHint: 'Chat messages and file metadata are kept on server and removed when the room expires',
      cacheEnabledLabel: 'Enable room file cache',
      cacheEnabledHint: 'Members who received a file can act as multi-sources; others / new members can fetch from them',
    ...
    room: {
      ...
      modeP2P: 'P2P',
      modeRelay: 'Relay',
      multiCameras: 'cameras in one window',
      ...
      roomCacheTitle: 'Room file cache',
      roomCacheHolders: 'source(s)',
      roomCacheFetch: 'Fetch',
      roomCacheSelf: 'This is your own cached file; no need to fetch',
      roomCacheRequested: 'Cache source notified; please wait for its confirmation',
      today: 'Today',
      yesterday: 'Yesterday',
    ...
    quality: {
      ...
      cameraPermissionDenied: 'Camera permission was blocked by the browser. Please allow camera access in browser settings / the address bar, then retry.',
      micPermissionDenied: 'Microphone permission was blocked by the browser. Please allow microphone access in browser settings / the address bar, then retry.',
      cameraPreviewRetry: 'Retry preview',
      cameraLoading: 'Loading camera…',
      cameraLoadTimeout: 'Camera load timed out. Check permissions or allow camera in your browser, then retry.',
      cameraSingleOnly: 'Only 1 camera detected — sharing in single-camera mode.',
    ...
    file: {
      ...
      cacheReady: '{holder} cached the file "{name}"; other members can fetch it',
